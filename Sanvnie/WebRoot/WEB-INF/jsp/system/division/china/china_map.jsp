...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/system/division/china/china_map.js"></script>
				...
				<div id="container">
				  <div style="font-size:12px;margin-top:15px;margin-left:5px;">
				    <div style="margin-bottom:25px;margin-left:7px;position: relative;"> <img id="map" name="map" usemap="#m_map"  src="${pageContext.request.contextPath}/images/map.jpg" alt="">
				      <div id="myzone" style="width:393px;position: absolute;left:-150px;top:470px;display:none;">
